...
# 🗣️ VOCE DI SINTESI FINALE
#    try:
#        frase = "Ho finito di eseguire il tuo comando, mio signore!"
#        subprocess.run(['espeak', '-v', 'it', frase])
#    except Exception as e:
#       print(f"⚠️ Impossibile riprodurre l'audio con espeak: {e}")


# 🗣️ NUOVA VOCE FINALE CON SPD-SAY
try:
    frase = "Ho finito di eseguire il tuo comando, mio signore!"
    # -l it imposta l'italiano, -t male1 imposta una voce maschile standard
